    ...
    <div>
      <main className={"main"}>
        <h1 className={"description"}>
          Используйте систему управления проектами Middleco для управления
          своими проектами с использованием досок Канбан. Общайтесь с коллегами
          во внутрипроектном чате.
        </h1>
        <h1
